 ...
 *
 * Modified By: Noel Tock - Added function to remove whites, blacks & shades
 * of gray from output (important for Theme Force).
 *
 */
class GetMostCommonColors
{
	...
	function Get_Color( $img, $count=20, $reduce_brightness=true, $reduce_gradients=true, $delta=16 )
	{
		...
		{
			echo "Image ".$img." does not exist or is unreadable";
			return false;
		}
	}
