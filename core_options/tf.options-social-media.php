...
function themeforce_social_media_overview_page() {
    ...
    <div class="wrap" id="tf-options-page">
        ...
        <!-- YELP -->
        <img src="<?php echo get_bloginfo('template_url').'/themeforce/assets/images/social_facebook.jpg'; ?>" />
        ...
        <!-- QYPE -->
        <img src="<?php echo get_bloginfo('template_url').'/themeforce/assets/images/social_twitter.jpg'; ?>" />
