	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
          ...
          if (itemurl.match(image)) {
            btnContent = '<img class="tf-options-img" style="max-width:400px" src="'+itemurl+'" alt="" /><a href="#" class="mlu_remove tf-button tf-inline">Remove Image</a>';
          } else {
            ...
            btnContent = '<div class="no_image"><span class="file_link">'+html+'</span><a href="#" class="mlu_remove tf-button tf-inline">Remove</a></div>';
          }
