...
function tf_gowalla_api_checkins() {
 ...
 * 
 */
function tf_delete_gowalla_checkins_transient_on_update_option() {
	
	delete_transient( 'tf_gowalla_checkins_json' );
}
add_action( 'update_option_tf_gowalla_api_key', 'tf_delete_gowalla_checkins_transient_on_update_option' );
add_action( 'update_option_tf_gowalla_spot_id', 'tf_delete_gowalla_checkins_transient_on_update_option' );